...
const images = ['https://cdn.midjourney.com/e46a3226-9280-47fb-a591-5a83b74b50cd/0_0.png',
...
const GridComponent = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="relative bg-black w-full" ref={gridRef} onMouseMove={handleMouseMove}>
