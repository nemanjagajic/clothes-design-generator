...
const RemoveOrderModal: React.FC<ConfirmModalProps> = ({ isOpen, onCancel, onRemove }) => {
    if (!isOpen) {
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal">
            <div className="relative top-40 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div className="mt-3 text-center">
                    <h3 className="text-2xl leading-6 font-medium text-gray-900">Da li si siguran?</h3>
                    ...
                    <div className="items-center px-4 py-3 space-x-4">
                        ...
                        <button id="confirm-btn" onClick={onRemove}
